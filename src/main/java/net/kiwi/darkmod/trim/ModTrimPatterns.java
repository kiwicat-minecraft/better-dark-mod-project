...
public class ModTrimPatterns {
    public static final RegistryKey<ArmorTrimPattern> VOID = RegistryKey.of(RegistryKeys.TRIM_PATTERN,
            Identifier.of(BetterDarkMod.MOD_ID, "void"));

    public static void bootstrap(Registerable<ArmorTrimPattern> context) {
        register(context, ModItems.VOID_DIAMOND_SMITHING_TEMPLATE, VOID);
    }
